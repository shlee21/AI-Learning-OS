...
- 글로벌 설치 시 `ALO`, 정식 명칭, GitHub 주소를 같은 시스템으로 연결
- 별도의 글로벌 Skill 없이 자연어로 ALO를 호출하는 사용법 추가

## 0.2.2 — 2026-08-07

- 개인 맞춤설정·맞춤형 지침의 효과를 비교하는 실험 문서 추가
- Evidence와 Reference, 정직한 답변, 질문 분석, 사고 확장 예제 제공
- 단순 질문의 과잉 형식과 불필요한 추가 질문을 막는 예외 조건 보완
